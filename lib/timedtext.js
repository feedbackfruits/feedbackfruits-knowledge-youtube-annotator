...
function getCaptionsForLanguage(videoURL, language) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return parseCaptions(videoURL, yield response.text(), language);
    });
}
...
function parseCaptions(videoURL, captionsString, language) {
    ...
    return json.transcript.text.map(caption => {
        ...
        return Object.assign({}, partialCaption, { "@id": id, "@type": [feedbackfruits_knowledge_engine_1.Context.iris.$.VideoCaption] });
    });
}
